...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'samathamvarshitha55566@gmail.com'  # Your Gmail address
...
>>>>>>> fae6cbb (Deleted all files inside media directory)
...
=======
CSRF_COOKIE_DOMAIN = '.smart-circular-market.com' 
>>>>>>> fae6cbb (Deleted all files inside media directory)
